        ...
        <div className="space-y-6 max-w-6xl mx-auto pb-12">
          <div className="glass-primary rounded-[32px] p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <Link
              ...
              className="glass-button-primary px-6 py-2.5 text-xs font-black gap-2 inline-flex items-center self-start sm:self-auto"
            >
          ...
          {isLoading ? (
            ...
            <div className="glass-secondary p-12 text-center space-y-4">
              ...
              <div>
                <h3 className="text-base font-extrabold text-slate-900">No interview attempts recorded yet.</h3>
              ...
              <Link
                href="/interviews/setup"
                className="glass-button-primary px-6 py-2.5 text-xs font-black gap-2 inline-flex items-center"
              >
                <PlayCircle className="w-4 h-4" />
