...
export default function LoginPage() {
  ...
  const { signInWithGoogle, loginAsDemoCandidate, loginAsAdmin } = useAuth();
  ...
  const handleCandidateDemo = async () => {
    setIsLoading(true);
        ...
        <Card className="shadow-card">
          ...
          <CardContent className="p-6 space-y-4">
            ...
            <Button
              ...
              className="w-full text-slate-500 hover:text-slate-900 gap-1.5"
            >
